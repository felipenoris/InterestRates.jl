...
@test_approx_eq ERF_to_rate(curve_b252_ec_lin, ERF(curve_b252_ec_lin, dt_maturity), ir.yearfraction(curve_b252_ec_lin, dt_maturity)) zero_rate(curve_b252_ec_lin, dt_maturity)
...
dt_maturity = dt_curve+Dates.Day(30)
@test_approx_eq ERF_to_rate(curve_ac360_cont_ff, ERF(curve_ac360_cont_ff, dt_maturity), ir.yearfraction(curve_ac360_cont_ff, dt_maturity)) zero_rate(curve_ac360_cont_ff, dt_maturity)
...
dt_maturity = dt_curve+Dates.Day(30)
@test_approx_eq ERF_to_rate(curve_ac365_simple_linear, ERF(curve_ac365_simple_linear, dt_maturity), ir.yearfraction(curve_ac365_simple_linear, dt_maturity)) zero_rate(curve_ac365_simple_linear, dt_maturity)
...
dt_maturity = dt_curve+Dates.Day(30)
@test_approx_eq ERF_to_rate(curve_step, ERF(curve_step, dt_maturity), ir.yearfraction(curve_step, dt_maturity)) zero_rate(curve_step, dt_maturity)
...
dt_maturity = dt_curve+Dates.Day(30)
@test_approx_eq ERF_to_rate(curve_NS, ERF(curve_NS, dt_maturity), ir.yearfraction(curve_NS, dt_maturity)) zero_rate(curve_NS, dt_maturity)
...
dt_maturity = dt_curve+Dates.Day(30)
@test_approx_eq ERF_to_rate(curve_spline_rates, ERF(curve_spline_rates, dt_maturity), ir.yearfraction(curve_spline_rates, dt_maturity)) zero_rate(curve_spline_rates, dt_maturity)
