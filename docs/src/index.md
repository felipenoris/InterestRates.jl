...
```@docs
InterestRates.ComposeProdFactorCurve
InterestRates.ComposeDivFactorCurve
```

## Source Code

The source code for this package is hosted at
[https://github.com/felipenoris/InterestRates.jl](https://github.com/felipenoris/InterestRates.jl).

## License

The source code for the package **InterestRates.jl** is licensed under
the [MIT License](https://raw.githubusercontent.com/felipenoris/InterestRates.jl/master/LICENSE).
